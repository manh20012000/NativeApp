    ...
    return (
      <View>
        <View style={styles.avatar}>
          <Image style={styles.imges} source={{ uri: count.Avatar }}></Image>
        </View>
        <View style={styles.usercnhan}>
          <Image
            style={{ width: 40, height: 40, borderRadius: 40 }}
            source={{ uri: count.Avatar }}
          ></Image>

          <Text style={styles.txt}>{count.Hoten}</Text>
        </View>
        ...
        <View style={styles.view5}>
          <Text style={{ fontSize: 15, fontWeight: "bold" }}>166 friend</Text>
          <TouchableOpacity onPress={setSeeInfor}>
            <Text style={{ color: "#222222", fontSize: 15, fontWeight: "bold" }}>
              Giới thiệu chung
            </Text>
          </TouchableOpacity>
        </View>
